    ...
    if (addCategoryBtn) {
        addCategoryBtn.addEventListener('click', function() {
            ...
            if (newCategory) {
                ...
                const existingCategories = Array.from(document.querySelectorAll('.category-list li'))
                    .map(li => li.dataset.category.toLowerCase());
                
                if (!existingCategories.includes(newCategory.toLowerCase())) {
                    // Add to category list
                    const li = document.createElement('li');
                    li.textContent = newCategory;
                    li.dataset.category = newCategory.toLowerCase();
                    
                    // Add before "Other" category
                    ...
                    // Add to category select in modal
                    ...
                    // Add click listener to new category
